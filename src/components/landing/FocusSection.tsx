      ...
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            {/* Connecting line */}
            <motion.div
              className="absolute left-8 top-16 bottom-16 w-0.5 bg-primary-200"
              initial={{ scaleY: 0 }}
            ...
            <div className="space-y-8">
              {steps.map((step, index) => (
                ...
                >
                  {/* Icon container */}
                  <motion.div
                    className={`relative w-16 h-16 rounded-full bg-gradient-to-br ${step.color} flex items-center justify-center shadow-medium`}
            ...
            <motion.div
              className="absolute -top-4 -right-4 w-6 h-6 bg-primary-300 rounded-full opacity-30"
              animate={{ y: [0, -10, 0], rotate: [0, 180, 360] }}
              transition={{ duration: 4, repeat: Infinity }}
            />
            <motion.div
              className="absolute bottom-4 -left-4 w-4 h-4 bg-primary-400 rounded-full opacity-40"
