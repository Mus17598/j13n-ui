...
const HeroBanner: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div 
        className="absolute inset-0 bg-gradient-radial from-primary-purple/20 to-transparent"
        style={{
      ...
      />
      <motion.div 
        className="absolute inset-0 bg-gradient-radial from-primary-blue/10 to-transparent"
        style={{
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            <div className="px-6 py-2 rounded-full bg-white/5 backdrop-blur-sm border border-white/10 shadow-inner">
              <div className="flex items-center gap-2">
                <div className="h-2 w-2 rounded-full bg-primary-purple animate-pulse-soft"></div>
      ...
      <div className="absolute bottom-8 left-0 right-0 flex justify-center">
        ...
        >
          <div className="w-[1px] h-10 bg-gradient-to-b from-white/0 to-white/50"></div>
